...
| --- | --- | --- | --- | --- |
| [Hierarchy and progressive disclosure 2026-07-10](in-progress/hierarchy-progressive-disclosure-2026-07-10.md) | active; revised story-poster direction implemented, browser/design QA and full gates pending | Product design, research, Writer Network, Realm Studio, surface contract, web, privacy, tests, and docs stewardship | 2026-07-24 | Current staging is audited with fresh desktop/mobile screenshots; one grounded direction is selected and implemented across community home, Writer Desk, Studio home, Studio Content, and a representative location; privacy, responsive, accessibility-risk, rendered, service, browser, docs, and changelog proof pass; real-user validation is recorded or remains an explicit post-alpha gap. |
...
| [Program Blueprint hydration 2026-05-02](in-progress/program-blueprint-hydration-2026-05-02.md) | implementation complete on issue #85 branch; archive after merge | Blueprint, service, storage, and test stewardship | 2026-07-20 | Typed current-realm diff, explicit collision modes, atomic hydration/audit, idempotency, rollback, tenant/ownership, migration, rendered Studio, docs, and changelog proof are merged. |
