...
| [Community sidebar navigation 2026-05-03](in-progress/community-sidebar-navigation-2026-05-03.md) | superseded by layered shell navigation; archive after useful notes move | Product/UI stewardship | 2026-05-30 | Historical context only; archive once any remaining useful verification notes are moved into the layered shell plan or implementation PRs. |
