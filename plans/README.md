...
| [Production readiness roadmap 2026-05-09](in-progress/production-readiness-roadmap-2026-05-09.md) | active production gate; local auth, tenant, privacy, and full test gates pass; live bootstrap and invite-only alpha smoke remain | Cross-steward production readiness | 2026-06-01 | Railway smoke is recorded, schema/seed persistence risks are resolved or explicitly deferred, S-tier core user flows have rendered and browser proof, and follow-up work is split into PR-sized implementation plans. |
