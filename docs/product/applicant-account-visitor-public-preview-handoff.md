...
| Pending access requester | Confirmation that the account/email request was received. | Wait for a director invitation or keep browsing public previews. | Director review notes, invite links, staff queue state, private request metadata. |
