...
- Notification target contracts require supported kinds to declare their target
  family and required fields before they can affect shell counts, inbox rows,
  open redirects, or mark-read mutations.
