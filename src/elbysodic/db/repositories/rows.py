...
def _community_access_request_event_from_row(row: sqlite3.Row) -> CommunityAccessRequestEvent:
    return CommunityAccessRequestEvent(
        id=row["id"],
        community_id=row["community_id"],
...
def _material_from_row(row: sqlite3.Row) -> Material:
    return Material(
        ...
        presentation_variant=row["presentation_variant"],
        summary=row["summary"],
        body=row["body"],
        status=row["status"],
        sort_order=row["sort_order"],
